...
specs: [
'src/tests/e2e/specs/LoginDE.spec.js',
...
'src/tests/e2e/specs/Q2-bugsBillmanager.spec.js',
    ...
    'src/tests/e2e/specs/SignUpUserNameLocale.spec.js',
...
onPrepare: function () {
protractor.loginHelpers = require('./src/tests/e2e/specs/LoginDE.spec.js');
...
outputPath: './src/tests/e2e/MV 2.0 Automation execution results-Deutsch/e2e',
screenshotPath: './src/tests/e2e/MV 2.0 Automation execution results-Deutsch/e2e',
