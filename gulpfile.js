...
gulp.task('copy-i18n', function () {
  log('Copying all i18n files to build target');
...
gulp.task('inject', ['wiredep', 'compile.sass', 'templatecache'], function() {
...
function serve(isDev, specRunner) {
  ...
  nodeOptions.nodeArgs = [debugMode + '=' + config.nodeDebugPort];
...
function startTests(singleRun, done) {
  ...
  if (args.startServers) {
    ...
    savedEnv.PORT = config.karma.port;
