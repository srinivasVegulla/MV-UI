...
//   beforeEach(inject(function(_exceptionHandlerProvider_){
//     exceptionHandlerProvider = _exceptionHandlerProvider_;
//   }));

//   it('exceptionHandler should be defined', function() {
//     expect(_exceptionHandlerProvider_).to.exist;
//   });
