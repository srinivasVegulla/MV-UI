...
expect(browser.getTitle()).toEqual(testdata.url.Title);
expect(browser.getCurrentUrl()).toMatch(loginurl);
element(by.css( testdata3.Languages.ES)).click();
browser.sleep(3000);
});
...
exports.lang = testdata3.Languages.ES;
exports.langCode="ES";
exports.PaymentsLang = testdata3.AccountSummary_Payments.ES;
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/changePassword/locale-es.json');
return testdata;        
};

exports.common = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/common/locale-es.json');
return testdata;
};
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/dashboard/locale-es.json');
return testdata;      
};

exports.expiredPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/expiredPassword/locale-es.json');
return testdata;
};

exports.forgotPasswordInstruction = function(){   
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/forgotPasswordInstruction/locale-es.json');
return testdata;
};

exports.nowCast = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/nowCast/locale-es.json');
return testdata;
};

exports.productViews = function(){  
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/locale-es.json');
return testdata;    
};

exports.resetPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/resetPassword/locale-es.json');
return testdata;
};

exports.security = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/security/locale-es.json');
return testdata;   
};

exports.signUp = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/signUp/locale-es.json');
return testdata;      
};

exports.viewSelector = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/viewSelector/locale-es.json');
return testdata;
};
...
var testdata4 = require(localeViewConfigPath+'ActivityLog_es.json');
...
var testdata4 = require(localeViewConfigPath+'Downloads_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'MiscAdjustment_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'NonstandardCharges_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PayerSubscriptions_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentMethods_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentReceived_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentsHistory_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PostBill_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PreBill_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'Subscriptions_es.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var keys = [] ;
var names = [];
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/DefaultProductView_es.json');
...
var languageSelect = localeSelectorData["Spanish"];
...
var countryCode = element(by.xpath(testdata3.Languages_Title.ES_Title));
browser.sleep(1000);
