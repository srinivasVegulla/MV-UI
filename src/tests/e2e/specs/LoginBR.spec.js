...
expect(browser.getTitle()).toEqual(testdata.url.Title);
expect(browser.getCurrentUrl()).toMatch(loginurl);
element(by.css( testdata3.Languages.BR)).click();
browser.sleep(3000);
});
...
exports.lang = testdata3.Languages.BR;
exports.langCode="BR";
exports.PaymentsLang = testdata3.AccountSummary_Payments.BR;
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/changePassword/locale-pt-br.json');
return testdata;        
};

exports.common = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/common/locale-pt-br.json');
return testdata;
};
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/dashboard/locale-pt-br.json');
return testdata;      
};

exports.expiredPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/expiredPassword/locale-pt-br.json');
return testdata;
};

exports.forgotPasswordInstruction = function(){   
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/forgotPasswordInstruction/locale-pt-br.json');
return testdata;
};

exports.nowCast = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/nowCast/locale-pt-br.json');
return testdata;
};

exports.productViews = function(){  
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/locale-pt-br.json');
return testdata;    
};

exports.resetPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/resetPassword/locale-pt-br.json');
return testdata;
};

exports.security = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/security/locale-pt-br.json');
return testdata;   
};

exports.signUp = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/signUp/locale-pt-br.json');
return testdata;      
};

exports.viewSelector = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/viewSelector/locale-pt-br.json');
return testdata;
};
...
var testdata4 = require(localeViewConfigPath+'ActivityLog_pt-br.json');
...
var testdata4 = require(localeViewConfigPath+'Downloads_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'MiscAdjustment_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'NonstandardCharges_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PayerSubscriptions_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentMethods_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentReceived_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentsHistory_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PostBill_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PreBill_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'Subscriptions_pt-br.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var keys = [] ;
var names = [];
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/defaultproductview_pt-br.json');
...
var languageSelect = localeSelectorData["Portugeese"];
...
var countryCode = element(by.xpath(testdata3.Languages_Title.BR_Title));
browser.sleep(1000);
