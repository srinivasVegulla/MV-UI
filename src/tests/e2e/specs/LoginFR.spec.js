...
expect(browser.getTitle()).toEqual(testdata.url.Title);
expect(browser.getCurrentUrl()).toMatch(loginurl);
element(by.css( testdata3.Languages.FR)).click();
browser.sleep(3000);
});
...
exports.lang = testdata3.Languages.FR;
exports.langCode="FR";
exports.PaymentsLang = testdata3.AccountSummary_Payments.FR;
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/changePassword/locale-fr.json');
return testdata;        
};

exports.common = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/common/locale-fr.json');
return testdata;
};
...
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/dashboard/locale-fr.json');
return testdata;      
};

exports.expiredPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/expiredPassword/locale-fr.json');
return testdata;
};

exports.forgotPasswordInstruction = function(){   
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/forgotPasswordInstruction/locale-fr.json');
return testdata;
};

exports.nowCast = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/nowCast/locale-fr.json');
return testdata;
};

exports.productViews = function(){  
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/locale-fr.json');
return testdata;    
};

exports.resetPassword = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/resetPassword/locale-fr.json');
return testdata;
};

exports.security = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/security/locale-fr.json');
return testdata;   
};

exports.signUp = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/signUp/locale-fr.json');
return testdata;      
};

exports.viewSelector = function(){
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/viewSelector/locale-fr.json');
return testdata;
};
...
var testdata4 = require(localeViewConfigPath+'ActivityLog_fr.json');
...
var testdata4 = require(localeViewConfigPath+'Downloads_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'MiscAdjustment_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'NonstandardCharges_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PayerSubscriptions_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentMethods_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentReceived_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PaymentsHistory_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PostBill_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'PreBill_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var testdata4 = require(localeViewConfigPath+'Subscriptions_fr.json');
var rawdata2 = JSON.stringify(testdata4);
rawdata2 = rawdata2.replace('{"columns":{"fields":[',",");
...
var keys = [] ;
var names = [];
var testdata = require('C:/ECB/METRAVIEW-CONFIG/UI-EXT-DATA/default/i18n/productViews/DefaultProductView_fr.json');
...
var languageSelect = localeSelectorData["French"];
...
var countryCode = element(by.xpath(testdata3.Languages_Title.FR_Title));
browser.sleep(1000);
