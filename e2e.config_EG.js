...
specs: [
'src/tests/e2e/specs/LoginEG.spec.js',
...
'src/tests/e2e/specs/Q2-bugsBillmanager.spec.js',
    ...
    'src/tests/e2e/specs/AccountInformationEdit.spec.js',
	...
	'src/tests/e2e/specs/ForgotPasswordRTL.spec.js',
	'src/tests/e2e/specs/RTL.spec.js'
...
onPrepare: function () {
protractor.loginHelpers = require('./src/tests/e2e/specs/LoginEG.spec.js');
...
outputPath: './src/tests/e2e/MV 2.0 Automation execution results-Arabic/e2e',
screenshotPath: './src/tests/e2e/MV 2.0 Automation execution results-Arabic/e2e',
