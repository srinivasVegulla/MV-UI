...
specs: [
'src/tests/e2e/specs/LoginGB.spec.js',
...
onPrepare: function () {
protractor.loginHelpers = require('./src/tests/e2e/specs/LoginGB.spec.js');
...
outputPath: './src/tests/e2e/MV 2.0 Automation execution results-English (GB)/e2e',
screenshotPath: './src/tests/e2e/MV 2.0 Automation execution results-English (GB)/e2e',
