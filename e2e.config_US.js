...
// Specs parameter for Protractor to execute
  specs: [
    'src/tests/e2e/specs/LoginUS.spec.js',
...
// before the specs are executed
  onPrepare: function () {
    protractor.loginHelpers = require('./src/tests/e2e/specs/LoginUS.spec.js');
...
// A callback function called once tests are finished.
  onComplete: function() {
    ...
    outputPath: './src/tests/e2e/MV 2.0 Automation execution results-English/e2e',
        screenshotPath: './src/tests/e2e/MV 2.0 Automation execution results-English/e2e',
